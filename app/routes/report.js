...
const getTransactionSummaryHandler = createReportHandler(
  ...
  (schemeId, year, revenueOrCapital, prn, frn) => addDetailsToFilename(storageConfig.summaryReportName, schemeId, year, prn, revenueOrCapital, frn),
...
const getClaimLevelReportHandler = createReportHandler(
  ...
  (schemeId, year, revenueOrCapital, prn, frn) => addDetailsToFilename(storageConfig.claimLevelReportName, schemeId, year, prn, revenueOrCapital, frn),
